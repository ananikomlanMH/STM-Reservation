...
<section class="home-section">
    <div class="link"><a href="#">Paramètres</a>
    </div>
    ...
    <div class="filter-form mt-25">
            ...
            <div class="search_box">
                ...
                <form action="" method="get">
                    <div class="search_field">
                        ...
                        @if(!empty($_GET))
                        <button class="filter"><a href="{{ route('users.index') }}">Effacer les
        ...
        <div class="right-content d-flex gap-1">
            ...
            <button class="btn-primary JS_Call_Url_Get_Form" data-url="{{ route('users.addForm', ['token' => $params['token']]) }}">Nouveau utilisateur<i class="fi-rr-plus"></i></button>
        </div>
    </div>
    ...
    <div class="table-list table-bordered table-striped ">
        <table>
            ...
            <tr>
                <th class="w-80"></th>
                <th>{!! $params['tables']->th('name') !!}</th>
                <th>{!! $params['tables']->th('email') !!}</th>
                <th>Password</th>
                <th class="w-80"></th>
            </tr>
            </thead>
            ...
            <tr>
                ...
                <td class="table_drop_action">
                    ...
                    <div class="dropdown">
                        <ul>
                            <li><a data-url="{{ route('users.editForm', ['token' => $params['token'], 'id' =>$user->id]) }}" class="JS_Call_Url_Get_Form"><i class="fi-rr-edit" ></i>Editer</a></li>
                            <li>
                                <form action="{{ route('users.delete') }}" method="post" class="deleteForm"
