...
<section class="home-section">
    ...
    <div class="filter-form mt-25">
            ...
            <div class="search_box">
                ...
                <form action="" method="get">
                    <div class="search_field">
                        ...
                        @if(!empty($_GET))
                        <button class="filter"><a href="{{ route('bus.index') }}">Effacer les
        ...
        <div class="right-content d-flex gap-1">
            ...
            <button class="btn-primary JS_Call_Url_Get_Form" data-url="{{ route('bus.addForm', ['token' => $params['token']]) }}">Nouveau bus<i class="fi-rr-plus"></i></button>
        </div>
    </div>
    ...
    <div class="table-list table-bordered table-striped ">
        <table>
            ...
            <tr>
                ...
                <th>{!! $params['tables']->th('numero') !!}</th>
                <th>{!! $params['tables']->th('nbreSiege') !!}</th>
                <th class="w-80"></th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr>
                ...
                <td class="table_drop_action">
                    ...
                    <div class="dropdown">
                        <ul>
                            <li><a data-url="{{ route('bus.editForm', ['token' => $params['token'], 'id' =>$bus->id]) }}" class="JS_Call_Url_Get_Form"><i class="fi-rr-edit" ></i>Editer</a></li>
                            <li>
                                <form action="{{ route('bus.delete') }}" method="post" class="deleteForm"
            ...
            @if(count($buss) === 0)
            <tr>
                <td colspan="5" style="text-align: center"> Aucun enregistrement trouvé</td>
            </tr>
            @endif
            </tbody>
        </table>
