...
<section class="home-section">
    <div class="link"><a href="#">Voyageurs</a>
    </div>
    ...
    <div class="filter-form mt-25">
            ...
            <div class="search_box">
                ...
                <form action="" method="get">
                    <div class="search_field">
                        ...
                        @if(!empty($_GET))
                        <button class="filter"><a href="{{ route('voyageur.index') }}">Effacer les
        ...
        <div class="right-content d-flex gap-1">
            ...
            <button class="btn-primary JS_Call_Url_Get_Form" data-url="{{ route('voyageur.addForm', ['token' => $params['token']]) }}">Nouveau voyageur<i class="fi-rr-plus"></i></button>
        </div>
    </div>
    ...
    <div class="table-list table-bordered table-striped ">
        <table>
            ...
            <tr>
                ...
                <th>{!! $params['tables']->th('adresse') !!}</th>
                <th class="w-80"></th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr>
                ...
                <td class="table_drop_action">
                    ...
                    <div class="dropdown">
                        <ul>
                            <li><a data-url="{{ route('voyageur.editForm', ['token' => $params['token'], 'id' =>$voyageur->id]) }}" class="JS_Call_Url_Get_Form"><i class="fi-rr-edit" ></i>Editer</a></li>
                            <li>
                                <form action="{{ route('voyageur.delete') }}" method="post" class="deleteForm"
                                      data-content="cette donnée">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $voyageur->id }}">
